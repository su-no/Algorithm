function solution(fees, records) {
  // console.log('기본 시간, 기본 요금, 단위 시간, 단위 요금');
  // console.log(fees);
  // console.log('시각(시:분), 차량 번호, 내역');
  // console.log(records);
  ...
  records.forEach((record) => {
    ...
    if (state === 'IN') {
      ...
      const netTime =
        parseInt(60 * outTime.split(':')[0]) + parseInt(outTime.split(':')[1])
        - parseInt(60 * inTime.split(':')[0]) - parseInt(inTime.split(':')[1]);
...
// console.log(solution([120, 0, 60, 591], [
//   '16:00 3961 IN',
//   '16:00 0202 IN',
//   '18:00 3961 OUT',
//   '18:00 0202 OUT',
//   '23:58 3961 IN'], [0, 591]
// ));
// console.log(solution([1, 461, 1, 10],
//   ['00:00 1234 IN'],
//   [14841]));